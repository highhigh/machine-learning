...
class LearningAgent(Agent):
    ...
    def reset(self, destination=None, testing=False):
		...
		#self.epsilon = 1 - (1/(1+math.exp(-k*self.alpha*(self.trials-t0)))) #sigmoid function: k-how fast the sigmoid function converges to 0; t0-empirical value.
		#self.epsilon = math.cos(0.05*self.trials)
    ...
    def get_maxQ(self, state):
        ...
        ########### 
        max_Qvalue = max(self.Q[state].values())
        best_actions = [action for action in self.valid_actions if self.Q[state][action] == max_Qvalue]
